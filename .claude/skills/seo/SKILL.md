...
- **Projeto ativo:** `projetos/<PROJETO>/` — identificar no início (ver Passo 0)
- **Contexto do negócio:** `projetos/<PROJETO>/_memoria/empresa.md`
- **Tom de voz:** `projetos/<PROJETO>/_memoria/preferencias.md`
- **Estratégia atual:** `projetos/<PROJETO>/_memoria/estrategia.md`
- **Ferramentas:** WebSearch, WebFetch (nativos)
- **Outputs vão em:** `projetos/<PROJETO>/marketing/seo/`
...
Se o usuário mencionou um projeto/cliente explicitamente, identificar o slug da pasta em `projetos/`. Se não for claro, listar as pastas em `projetos/` e perguntar: "Qual projeto?". Definir `BASE = projetos/<projeto>` e usar esse prefixo em todos os caminhos abaixo.

### Passo 1 — DEMANDA: O que as pessoas buscam nesse nicho?

**Objetivo:** Entender se existe demanda real e como as pessoas buscam.

1. Ler `{BASE}/_memoria/empresa.md` pra extrair: produtos/serviços, região, público-alvo, diferenciais
...
**Output:** Salvar em `{BASE}/marketing/seo/01-pesquisa-demanda.md` com:
...
**Output:** `{BASE}/marketing/seo/02-analise-concorrencia.md` com:
...
2. Criar documento com **tudo que precisa ser preenchido/otimizado:**
   ...
   **Descrição do negócio:**
   ...
   - Tom: conforme `{BASE}/_memoria/preferencias.md`
...
**Output:** `{BASE}/marketing/seo/03-google-meu-negocio.md`
...
**Output:** `{BASE}/marketing/seo/04-otimizacao-on-page.md` com:
...
**Output:** `{BASE}/marketing/seo/05-estrategia-conteudo.md`
...
3. **Copies dos anúncios:**
   - Seguir tom de `{BASE}/_memoria/preferencias.md`
...
**Output:** `{BASE}/marketing/seo/06-google-ads.md` com estrutura completa, palavras-chave organizadas, copies prontas, orçamento e configurações.
...
**Output:** `{BASE}/marketing/seo/07-checklist-monitoramento.md`
...
**Output:** `{BASE}/marketing/seo/08-geo-otimizacao-ia.md` com auditoria, FAQ + schema JSON-LD, lista de ações pra aumentar citações, checklist de monitoramento.
...
- Copies e textos seguem `{BASE}/_memoria/preferencias.md` estritamente
